package com.nate.pitit.ui.theme.screens.home_screen
...
import com.nate.pitit.common.Constants
import com.nate.pitit.data.local.entity.TransactionDataTransferObject
import com.nate.pitit.models.Transaction
import com.nate.pitit.models.usecase.GetDateFormattedUseCase
import com.nate.pitit.models.usecase.GetDateUseCase
import com.nate.pitit.models.usecase.read_database.GetAccountUseCase
import com.nate.pitit.models.usecase.read_database.GetAccountsUseCase
import com.nate.pitit.models.usecase.read_database.GetAllTransactionsUseCase
import com.nate.pitit.models.usecase.read_database.GetCurrentDayExpTransactionUseCase
import com.nate.pitit.models.usecase.read_database.GetDailyTransactionUseCase
import com.nate.pitit.models.usecase.read_database.GetMonthlyExpTransactionUseCase
import com.nate.pitit.models.usecase.read_database.GetWeeklyExpTransactionUseCase
...
import com.nate.pitit.models.usecase.write_database.InsertNewTransactionUseCase
import com.nate.pitit.ui.theme.businessBg
import com.nate.pitit.ui.theme.clothBg
import com.nate.pitit.ui.theme.electricBg
import com.nate.pitit.ui.theme.food_drink
import com.nate.pitit.ui.theme.gadgetBg
import com.nate.pitit.ui.theme.giftBg
import com.nate.pitit.ui.theme.groceryBg
import com.nate.pitit.ui.theme.healthBg
import com.nate.pitit.ui.theme.homeBg
import com.nate.pitit.ui.theme.leisureBg
import com.nate.pitit.ui.theme.miscBg
import com.nate.pitit.ui.theme.petBg
import com.nate.pitit.ui.theme.schBg
import com.nate.pitit.ui.theme.snackBg
import com.nate.pitit.ui.theme.subBg
import com.nate.pitit.ui.theme.taxiBg
import com.nate.pitit.ui.theme.travelBg
import com.nate.pitit.ui.theme.vehicleBg
...
class HomeViewModel @Inject constructor(
    ...
    private val getMonthlyExpTransactionUse: GetMonthlyExpTransactionUseCase
) : ViewModel() {
    ...
    fun insertDailyTransaction(
        ...
        viewModelScope.launch(Dispatchers.IO) {
            ...
            val newTransaction = TransactionDataTransferObject(
                currentTime.value,
                date,
                amount,
                account.value.title,
    ...
    fun updateTransaction(
        ...
        if (transactionPos != -1 && transactionStatus != -1) {
            ...
            viewModelScope.launch(Dispatchers.IO) {
                ...
                val updateTransaction = TransactionDataTransferObject(
                    transaction.date,
